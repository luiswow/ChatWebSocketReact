interface IcreateChatGuestComponent {
  message: string;
  user: string;
}
...
export const createChatUserComponent = (user: string, message: string) => {
...
export const createChatGuestComponent = ({
  message,
  user,
}: IcreateChatGuestComponent) => {
  let divElement = document.createElement('div');
