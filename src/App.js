...
import {createChatUserComponent,createChatGuestComponent} from "./chatComponent/chatContainers/chatContainers"
...
const handleSendMessage= ()=>{
  ...
  if(user != ""){
   ...
   let containerChatReference = document.getElementById("referencia");      
                ...
                <div className="box-footer">
                    ...
                    <div className="input-group">
                      ...
                      <span className="input-group-btn">
                        <button onClick={()=>handleSendMessage} type="button" className="btn btn-warning btn-flat">Send</button>
                      </span>
                    </div>
